    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("REST API for Analytics Backend with JWT authentication, user management, event tracking, and external service integration")
                        .contact(new Contact()
                                .name("Danny Vaca")
                                .email("danny270793@github.io")
